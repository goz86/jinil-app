...
const KoreanNewsWidget = () => {
  ...
  return (
    <div className="backdrop-blur-md bg-white/75 dark:bg-slate-800/75 rounded-2xl shadow-sm border border-white/80 dark:border-slate-700/70 p-5 mt-6 relative z-10 transition-all duration-300">
