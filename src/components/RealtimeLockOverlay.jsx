...
export default function RealtimeLockOverlay({ isLocked, lockReason, message, userEmail, onRefresh }) {
      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-3xl p-8 max-w-lg w-full text-center shadow-2xl flex flex-col items-center gap-6 relative overflow-hidden">
        ...
        <div className="flex items-center justify-center gap-3 w-full pt-2">
          ...
          <a
            ...
            className="flex-1 py-3 px-4 bg-red-600 hover:bg-red-500 text-white font-bold text-xs rounded-xl transition-all shadow-lg cursor-pointer flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <span>관리자 (pc5@gmail.com) 문의</span>
          </a>
        </div>
      </div>
    </div>
