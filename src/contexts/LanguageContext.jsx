...
const translations = {
    vi: {
        ...
        notes: "노트",
        notesModalTitle: "Ghi chú công việc & Bảo mật",
        searchNotesPlaceholder: "Tìm kiếm ghi chú, khách hàng, mật khẩu...",
        newNote: "Tạo ghi chú mới",
        allNotes: "Tất cả",
        pinnedNotes: "Đã ghim",
        clientCategory: "Khách hàng & Địa chỉ",
        accountCategory: "Tài khoản & Mật khẩu",
        generalCategory: "Ghi chú chung",
        todoCategory: "Checklist / Việc cần làm",
        noteTitlePlaceholder: "Tiêu đề ghi chú...",
        noteContentPlaceholder: "Viết ghi chú chi tiết ở đây...",
        clientNameLabel: "Tên khách hàng / Đơn vị",
        clientPhoneLabel: "Số điện thoại",
        clientAddressLabel: "Địa chỉ nhận hàng",
        accountUsernameLabel: "ID / Tài khoản",
        accountPasswordLabel: "Mật khẩu",
        accountUrlLabel: "Liên kết / Trang đăng nhập",
        copied: "Đã sao chép!",
        pinNote: "Ghim ghi chú",
        unpinNote: "Bỏ ghim",
        lastEditedBy: "Chỉnh sửa bởi",
        noNotesFound: "Chưa có ghi chú nào",
    ...
    ko: {
        ...
        notes: "노트",
        notesModalTitle: "업무 노트 & 계정 관리",
        searchNotesPlaceholder: "노트, 거래처, 비밀번호 검색...",
        newNote: "새 노트 작성",
        allNotes: "전체",
        pinnedNotes: "고정됨",
        clientCategory: "거래처 & 주소",
        accountCategory: "계정 & 비밀번호",
        generalCategory: "일반 메모",
        todoCategory: "체크리스트 / 할 일",
        noteTitlePlaceholder: "노트 제목...",
        noteContentPlaceholder: "상세 내용을 여기에 작성하세요...",
        clientNameLabel: "거래처명 / 고객명",
        clientPhoneLabel: "연락처",
        clientAddressLabel: "배송 주소",
        accountUsernameLabel: "아이디 / 계정",
        accountPasswordLabel: "비밀번호",
        accountUrlLabel: "접속 링크 / 사이트",
        copied: "복사되었습니다!",
        pinNote: "상단 고정",
        unpinNote: "고정 해제",
        lastEditedBy: "수정자",
        noNotesFound: "등록된 노트가 없습니다",
